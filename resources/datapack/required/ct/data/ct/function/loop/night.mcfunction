...
tellraw @s[tag=!storyteller,tag=!spectator,scores={reveal_cd=1}] [{"text":"! ","color":"yellow","bold":true},{"text":"Press ", "extra": [{"keybind": "key.chat"}, {"text": " to release your mouse, then hover over your character icon in the top left to see your ability."}],"color":"gray","bold":false}]
