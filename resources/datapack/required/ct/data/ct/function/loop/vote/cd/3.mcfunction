...
execute if score organ_grinder settings matches 1 run effect give @a[tag=!storyteller,tag=!spectator] minecraft:blindness infinite 30 true
execute if score organ_grinder settings matches 1 run effect give @a[tag=!storyteller,tag=!spectator] minecraft:darkness infinite 30 true
