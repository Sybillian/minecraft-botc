execute as @e[type=minecraft:item_display] at @s if score @s id = @a[limit=1,tag=voting_now] id run particle minecraft:soul_fire_flame ~ ~ ~ 0.25 0.25 0.25 0.05 100
