...
item replace entity @s[tag=dead,tag=!expended_ghost] weapon.offhand with minecraft:carrot_on_a_stick[minecraft:custom_model_data={"strings":["voting_ghost","voting"]},custom_name=[{text:"Voting ",color:"white",italic:false},{text:"YES",color:"aqua",italic:false},{text:" [Right-Click]",color:"gray",italic:false}]]
