execute unless block ~ -64 ~ #ct:vc_marker run voicechat leave
tag @s remove beets
tag @s remove wheat
tag @s remove church
...
execute if block ~ -64 ~ minecraft:mangrove_planks run tellraw @s[tag=!in_vc] [{"text":" Joined the Inn chat.","color":"gray","italic":true,"bold":false}]
execute if block ~ -64 ~ minecraft:pale_oak_planks run tellraw @s[tag=!in_vc] [{"text":" Joined the Greenhouse chat.","color":"gray","italic":true,"bold":false}]
...
execute if block ~ -64 ~ minecraft:mangrove_planks run tag @s add inn
execute if block ~ -64 ~ minecraft:pale_oak_planks run tag @s add greenhouse
...
execute if block ~ -64 ~ minecraft:dark_oak_planks run voicechat join "Beet Fields" ct
execute if block ~ -64 ~ minecraft:oak_planks run voicechat join "Wheat Fields" ct
